  ...
  return (
    <>
      ...
      >
        ...
        <View className="absolute top-14 right-6 bg-secondary dark:bg-secondary-foreground w-1/2 rounded-lg shadow-2xl border border-gray-300">
          <View className="border-b border-gray-300 pb-6">
